// Translation module - handles internationalization
const Translations = (() => {
  'use strict';
  ...
  const translations = {
    en: {
      ...
      'skill-python': 'Ongoing learning in Deep Learning',
      'skill-dataviz': 'Hugging Face',
      'skill-nlp': 'Python',
      'skill-cv': 'LangChain/LangGraph',
      'skill-dl': 'Vector Databases',
      
      // Projects
      'projects-title': 'Featured Projects',
      'project1-title': 'AI Assistant Platform',
      'project1-desc': 'Tired of reading PDF files? Ask your questions about my experience, projects, or skills directly to this AI assistant. Built with RAG architecture to ensure precise, fact-based answers directly from my CV.',
    ...
    sv: {
      ...
      'hero-desc': 'Jag älskar att förvandla idéer till kod – särskilt när AI är inblandat. Från maskininlärning till smarta appar handlar det för mig om att utforska, experimentera och bygga saker som driver tekniken (och mig själv) lite längre fram varje dag.<br><br>Att lansera liveprojekt på min Hetzner-server har visat mig kicken i att förvandla idéer till verklighet – och varje ny utmaning driver både mina färdigheter och min nyfikenhet lite längre för varje dag.',
      'hero-btn-projects': 'Testa min CV-Bot',
      ...
      'skill-python': 'Pågående fördjupning i Deep Learning',
      'skill-dataviz': 'Hugging Face',
      'skill-nlp': 'Python',
      'skill-cv': 'LangChain/LangGraph',
      'skill-dl': 'Vektordatabaser',
      
      // Projects
      'projects-title': 'Utvalda projekt',
      'project1-title': 'AI-assistentplattform',
      'project1-desc': 'Trött på att läsa PDF-filer? Ställ dina frågor om min erfarenhet, projekt eller kunskaper direkt till denna AI-assistent. Byggd med RAG-arkitektur för att garantera precisa, faktabaserade svar direkt från mitt CV.',
  ...
  const get = (key, lang) => translations[lang]?.[key] || translations.en[key] || key;
  
  const getLanguage = () => translations;
